...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-4 md:px-10 ${scrolled ? 'py-2 md:py-3' : 'py-4 md:py-6'} bg-transparent print:hidden`}>

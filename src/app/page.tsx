        ...
        <section className="pb-0 pt-4 md:pt-8 px-6 md:px-12 max-w-[1600px] mx-auto bg-surface">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              {[
                { id: 'signature-full-set', name: "Signature Full Set", duration: "2h", price: "₦20,000", desc: "Acrylics, BIAB & hard gel extensions with either French tips, simple accents, swirls, simple ombré.", image: "https://images.unsplash.com/photo-1604654894610-df63bc536371?auto=format&fit=crop&w=200&q=80" },
                { id: 'elevated-full-set', name: "Elevated Full Set", duration: "2h", price: "₦25,000", desc: "Acrylics, BIAB & hard gel extensions with up to two design elements or 3d art.", image: "https://images.unsplash.com/photo-1522337660859-02fbefca4702?auto=format&fit=crop&w=200&q=80" },
                { id: 'statement-full-set', name: "Statement Full Set", duration: "2h 30min", price: "₦35,000", desc: "Acrylic, BIAB or hard gel extensions with intricate nail art, detailed hand painted designs and multiple layered nail design elements.", image: "https://images.unsplash.com/photo-1519415510236-718bdfcd89c8?auto=format&fit=crop&w=200&q=80" },
                { id: 'gel-manicure', name: "Gel Polish Manicure", duration: "1h 15min", price: "₦12,000", desc: "Detailed cuticle work and shaping, finished with your choice of solid gel color.", image: "https://images.unsplash.com/photo-1632345031435-8727f6897d53?auto=format&fit=crop&w=200&q=80" },
                { id: 'in-fill', name: "In-Fill / Maintenance", duration: "1h 30min", price: "₦15,000", desc: "Rebalancing and filling growth on existing enhancements. Includes one gel color.", image: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?auto=format&fit=crop&w=200&q=80" },
                { id: 'nail-art-addons', name: "Nail Art / Add-ons", duration: "15min+", price: "₦2,000", desc: "Extra length, intricate character art, chrome powders, or rhinestones added to any service.", image: "https://images.unsplash.com/photo-1515377905703-c4788e51af15?auto=format&fit=crop&w=200&q=80" },
              ].map((service) => {

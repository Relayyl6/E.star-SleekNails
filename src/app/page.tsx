    ...
    <div className="relative">
      ...
      <div className="bg-surface relative z-20">
        ...
        <div className="fixed bottom-6 right-6 z-40 flex flex-row items-center gap-3">
          ...
          <Link href="/policy" className="bg-white/80 backdrop-blur-md border border-black/10 w-12 h-12 md:w-auto md:h-auto md:px-4 md:py-2 rounded-full shadow-lg hover:shadow-xl hover:bg-white text-gray-700 hover:text-primary transition-all flex items-center justify-center gap-2">
            <svg className="w-5 h-5 md:w-3.5 md:h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
            <span className="hidden md:inline text-xs font-semibold">Policy & Terms</span>
          </Link>
        </div>
      </div>
    </div>
